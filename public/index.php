...
<header class="bg-white border-b border-gray-200 sticky top-0 z-50 px-4 py-3 shadow-sm">
    <div class="max-w-4xl mx-auto flex justify-between items-center">
        ...
        <div>
            <a href="logowanie.php" class="bg-gray-100 hover:bg-gray-200 text-gray-800 text-xs font-semibold px-4 py-2 rounded-xl border border-gray-200 transition flex items-center space-x-2">
                <i aria-hidden="true" class="fa-solid fa-user-circle text-mobiRed text-sm"></i>
